...
from src.category_b import service
...
def get_pages_by_user_id(user_id: str = Query(..., description="User ID.")):
    """
...
def get_articles_by_domain(domain: str = Query(..., description="Specified domain")):
    """
...
def get_page_by_id(page_id: str = Query(..., description="Page ID")):
    """
...
def get_page_by_id(start_time: str = Query(..., description="The start of period"),
                   end_time: str = Query(..., description="The end of period")):
    """
